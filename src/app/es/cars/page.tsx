...
const sortLabels: Record<SortOption, string> = {
  ...
  'deposit-low': 'Depósito (menor a mayor)',
};
      ...
      <Section background="primary" padding="lg" className="border-b border-[var(--border)]">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-xl text-[var(--text-muted)] mb-8">
            Elige tu coche y envía una solicitud de reserva en minutos.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          {filteredAndSortedCars.length === 0 ? (
            <div className="text-center py-16">
              <p className="text-xl text-[var(--text-muted)]">No se encontraron coches que coincidan con tus criterios.</p>
            </div>
          ) : (
                  ...
                  <ScrollReveal key={car.id} delay={index * 50}>
                    ...
                    <div className="flex-1 flex flex-col">
                      ...
                      <div className="flex flex-col sm:flex-row gap-2">
                        <Link href={`/es/cars/${car.slug}`} className="flex-1">
                          <Button variant="outline" size="md" className="w-full">
                            Ver detalles
                          </Button>
                        </Link>
                        <Link href={`/es/booking?car=${car.slug}`} className="flex-1">
