...
const sortLabels: Record<SortOption, string> = {
  ...
  'price-high': 'Preis (hoch bis niedrig)',
  'deposit-low': 'Kaution (niedrig bis hoch)',
};
      ...
      <Section background="primary" padding="lg" className="border-b border-[var(--border)]">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-xl text-[var(--text-muted)] mb-8">
            Wählen Sie Ihr Auto und senden Sie eine Buchungsanfrage in wenigen Minuten.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          {filteredAndSortedCars.length === 0 ? (
            <div className="text-center py-16">
              <p className="text-xl text-[var(--text-muted)]">Keine Autos gefunden, die Ihren Kriterien entsprechen.</p>
            </div>
          ) : (
                    ...
                    <div className="flex-1 flex flex-col">
                      ...
                      <div className="border-t border-[var(--border)] pt-4 mb-4 space-y-2">
                        ...
                        <div className="text-sm text-[var(--text-muted)]">
                          Kaution: {formatEUR(car.deposit)}
                        </div>
                      </div>

                      {/* Actions */}
                      <div className="flex flex-col sm:flex-row gap-2">
                        <Link href={`/de/cars/${car.slug}`} className="flex-1">
                          <Button variant="outline" size="md" className="w-full">
                            Details anzeigen
                          </Button>
                        </Link>
                        <Link href={`/de/booking?car=${car.slug}`} className="flex-1">
