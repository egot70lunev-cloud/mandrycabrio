...
export const metadata: Metadata = generatePageMetadata({
  ...
  description: "Premium car rental in Tenerife. Discover our collection of cabrio, SUV, and luxury vehicles. Book your perfect ride with style and comfort.",
  path: "/en",
  locale: 'en',
});
                ...
                <ScrollReveal delay={0}>
                  <div className="text-[var(--text)]">
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                      Premium Car Rental in Tenerife
                    </h1>
                    <p className="text-xl md:text-2xl text-[var(--text-muted)] mb-8 leading-relaxed">
                      Experience luxury car rental with our premium collection of cabrio, SUV, and luxury vehicles.
                    </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <ScrollReveal delay={0}>
              <Card className="text-center">
                ...
                <h3 className="text-xl font-semibold text-[var(--text)] mb-2">Full Insurance</h3>
                <p className="text-[var(--text-muted)]">Comprehensive coverage included with every rental</p>
              </Card>
            </ScrollReveal>
            ...
            <ScrollReveal delay={100}>
              <Card className="text-center">
                ...
                <p className="text-[var(--text-muted)]">Available via WhatsApp for any assistance</p>
              </Card>
            </ScrollReveal>
            ...
            <ScrollReveal delay={200}>
              <Card className="text-center">
                ...
                <h3 className="text-xl font-semibold text-[var(--text)] mb-2">Premium Fleet</h3>
                <p className="text-[var(--text-muted)]">Carefully selected luxury and premium vehicles</p>
              </Card>
            </ScrollReveal>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <ScrollReveal delay={0}>
            <div className="text-center mb-8">
              <h2 className="text-3xl md:text-4xl font-bold text-[var(--text)] mb-4">Customer Reviews</h2>
              <p className="text-xl text-[var(--text-muted)]">See what our customers say about their experience</p>
            </div>
          </ScrollReveal>
